...
for i in README LEEME.extra PAQUETES PROYECTO; do
    ...
    %__mv  %{extra_pkg_name}/$i.utf8 %{extra_pkg_name}/$i
done
%__mv %{extra_pkg_name}/README %{extra_pkg_name}/README.extra

# Bug 388391
%__rm %{extra_pkg_name}/man1/mc.1
%__rm %{extra_pkg_name}/man1/newgrp.1
# Bug 226124
for i in man3/dlopen.3 man5/acct.5 man5/host.conf.5 man5/resolver.5 man8/ld.so.8; do
    iconv -f UTF-8 -t UTF-8 $i -o $i.utf8
    %__mv $i.utf8 $i
    %__rm %{extra_pkg_name}/$i
done
...
%__rm $RPM_BUILD_ROOT%{es_man_dir}/PAQUETES
%__rm $RPM_BUILD_ROOT%{es_man_dir}/PROYECTO
#[Bug 427684] man-pages fileconflict
#- Fix the conflict with vipw.8 (in shadow-utils)
%__rm $RPM_BUILD_ROOT%{es_man_dir}/man8/vipw.8
...
%{es_man_dir}/man2/getitimer.2.gz
